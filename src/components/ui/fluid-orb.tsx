...
function hexToRgb(hex: string): [number, number, number] {
  ...
  if (value.length !== 6 || Number.isNaN(number)) return [0.1, 0.45, 0.95];
...
/**
 * Rare UI Fluid Orb, kept locally so it can be adjusted with the design system.
 * It holds a still frame when the visitor prefers reduced motion.
 */
