...
import { CONTACT, waLink } from "./site-config";
  ...
  return (
    <div className="fixed bottom-4 right-4 z-40 flex flex-col items-end gap-2.5 sm:bottom-6 sm:right-6">
      ...
      <a
        ...
        aria-label="Instagram de ServiTec"
        className="grid size-12 place-items-center rounded-full bg-gradient-to-tr from-amber-400 via-rose-500 to-fuchsia-600 text-white shadow-soft-lg transition-transform hover:scale-105 sm:size-14"
      >
